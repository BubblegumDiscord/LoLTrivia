...
def get_champion(id_):
    ...
    """
    request = "{version}/champions/{id_}".format(version=cassiopeia.dto.requests.api_versions["staticdata"], id_=id_)
...
def get_champions():
    ...
    """
    request = "{version}/champions".format(version=cassiopeia.dto.requests.api_versions["staticdata"])
...
def get_item(id_):
    ...
    Returns:
        Item: the item
    """
    request = "{version}/items/{id_}".format(version=cassiopeia.dto.requests.api_versions["staticdata"], id_=id_)
...
def get_items():
    ...
    """
    request = "{version}/items".format(version=cassiopeia.dto.requests.api_versions["staticdata"])
...
def get_maps():
    ...
    """
    request = "{version}/maps".format(version=cassiopeia.dto.requests.api_versions["staticdata"])
...
def get_mastery(id_):
    ...
    Returns:
        Mastery: the mastery
    """
    request = "{version}/masteries/{id_}".format(version=cassiopeia.dto.requests.api_versions["staticdata"], id_=id_)
...
def get_realm():
    ...
    """
    request = "{version}/realms".format(version=cassiopeia.dto.requests.api_versions["staticdata"])
...
def get_rune(id_):
    ...
    Returns:
        Rune: the rune
    """
    request = "{version}/runes/{id_}".format(version=cassiopeia.dto.requests.api_versions["staticdata"], id_=id_)
...
def get_runes():
    ...
    """
    request = "{version}/runes".format(version=cassiopeia.dto.requests.api_versions["staticdata"])
...
def get_summoner_spell(id_):
    ...
    """
    request = "{version}/summoner-spells/{id_}".format(version=cassiopeia.dto.requests.api_versions["staticdata"], id_=id_)
